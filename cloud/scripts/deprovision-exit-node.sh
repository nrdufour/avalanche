...
# Confirmation prompt
read -p "$(echo -e ${RED}Are you sure you want to delete these resources? [y/N]:${NC} )" -n 1 -r
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
...
echo "1. Remove the device from Tailscale admin panel"
echo "   https://login.tailscale.com/admin/machines"
echo "2. Update any K8s services that were using this exit node"
echo -e "${GREEN}================================${NC}"
