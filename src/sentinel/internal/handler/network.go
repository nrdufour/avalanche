...
func NewNetworkHandler(sessions *auth.SessionManager, cfg *config.Config, diagnostics *collector.DiagnosticsRunner, adguard *collector.AdGuardCollector) *NetworkHandler {
